...
save_file_to = '/data/Adoption_data_new/result/exposure.json'
...
for project in tqdm(project_list):
    ...
    for adoption in adoptions[project]:
        ...
        for time_stamp in interval[0]:
            ...
            exposure_dict[project][tool].append(number_of_exposed_members/number_of_active_members)
